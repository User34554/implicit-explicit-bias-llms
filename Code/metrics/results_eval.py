...
df = pd.read_excel(input_file, sheet_name="ali_stereo")

# --- Step 2: Define models and ground truth ---
ground_truth_col = "ground_truth=1"  # Replace with your ground truth column name
...
for model in model_cols:
    ...
    recall = recall_score(df[ground_truth_col], df[model])
