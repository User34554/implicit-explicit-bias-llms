...
# === CONFIGURATION ===
INPUT_FILE = "DPO_bias_data_fr.xlsx"
OUTPUT_FILE = "acceptreject_fr.xlsx"
...
for i, row in df.iterrows():
    ...
    if label == 0:  # Only bias biased sentences
